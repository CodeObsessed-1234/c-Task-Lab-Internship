...
class departmentManagment: public employeeManagment
{
    public:
        ...
        void DepartmentAdd(int id){
            emp.EmployeeAddDepartment(id);
        }
        void EditDepartment(int id){
            emp.EmployeeEditDepartment(id);
        }
        void DeleteDepartment(int id){
            emp.EmployeeDeleteDepartment(id);
        }
        void ListDepartmentAdd(){
...
int main()
{
    ...
    while (true)
    {
        cout << "Press D for Department\n"
             ...
             << "Press Any Character Key for Exit"
             << "\n";
        cout << endl;
        cout << "Enter Choice:- ";
        cin >> choice;
